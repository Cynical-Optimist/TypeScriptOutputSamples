...
export namespace Morphir_IR_Package {
  ...
  */
  ...
  return codecs.decodeRecord(new Map([["modules", codecs.decodeDict.bind(null, Morphir_IR_Module.decodeModuleName.bind(null, varDecoders), Morphir_IR_AccessControlled.decodeAccessControlled.bind(null, varDecoders))]]), input);
  }
  ...
  */
  ...
  return codecs.decodeRecord(new Map([["modules", codecs.decodeDict.bind(null, Morphir_IR_Module.decodeModuleName.bind(null, varDecoders), Morphir_IR_Module.decodeSpecification.bind(null, varDecoders))]]), input);
  }
