...
export namespace Morphir_IR_Module {
  ...
  */
  ...
  return codecs.decodeRecord(new Map([["types", codecs.decodeDict.bind(null, Morphir_IR_Name.decodeName.bind(null, varDecoders), Morphir_IR_AccessControlled.decodeAccessControlled.bind(null, varDecoders))], ["values", codecs.decodeDict.bind(null, Morphir_IR_Name.decodeName.bind(null, varDecoders), Morphir_IR_AccessControlled.decodeAccessControlled.bind(null, varDecoders))]]), input);
  }
  ...
  */
  ...
  return Morphir_IR_Path.decodePath(varDecoders, input);
  }
  ...
  */
  ...
  return codecs.decodeRecord(new Map([["types", codecs.decodeDict.bind(null, Morphir_IR_Name.decodeName.bind(null, varDecoders), Morphir_IR_Documented.decodeDocumented.bind(null, varDecoders))], ["values", codecs.decodeDict.bind(null, Morphir_IR_Name.decodeName.bind(null, varDecoders), Morphir_IR_Value.decodeSpecification.bind(null, varDecoders))]]), input);
  }
