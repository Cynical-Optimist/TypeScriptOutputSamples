...
export namespace Morphir_Reference_Model_Issues_Issue409 {
  ...
  return codecs.decodeRecord(new Map([["basicEnum", codecs.decodeUnit.bind(null)], ["otherBasicEnum", codecs.decodeUnit.bind(null)], ["id", codecs.decodeString.bind(null)]]), input);
  }
